Gem::Specification.new do |s|
  ...
  s.summary  = %q{Make your Rails 8 resources accessible via WebDAV}
  s.homepage = %q{http://github.com/wvk/railsdav}
  s.description = %q{Provides basic Rails 8 extensions for making your business resources accessible via WebDAV. This gem does by no means by no means implement the full WebDAV semantics, but it suffices to access your app with client(-libs) such as Konqueror, cadaver, davfs2 or NetDrive}
